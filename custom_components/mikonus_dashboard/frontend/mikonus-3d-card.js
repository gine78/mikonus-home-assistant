var S="homeAssistant",w=/^[a-z][a-z0-9_]*\.[a-z0-9_]+$/,O=new Set(["light","switch","cover","climate","lock","vacuum","binary_sensor"]),W={light:["power","brightness","color","colorTemperature"],switch:["power"],cover:["position","coverMovement","openState"],climate:["currentTemperature","targetTemperature","humidity","hvacMode","hvacAction"],lock:["lockState"],vacuum:["startStop","cleaningState","returnToBase","batteryLevel","chargingState"],binary_sensor:["motion","occupancy","openState","smokeAlarm","waterLeak","alarm"]},j={motion:["motion","activity","motion"],occupancy:["occupancy","activity","occupancy"],presence:["occupancy","activity","presence"],opening:["contact","contact","openState"],door:["contact","contact","openState"],window:["contact","contact","openState"],smoke:["smoke","safety","smoke"],moisture:["water","safety","water"]},m=r=>typeof r=="number"&&Number.isFinite(r)?r:null,y=(r,e,t)=>m(r)===null?null:Math.max(e,Math.min(t,r)),L=r=>Array.isArray(r)?[...new Set(r.filter(e=>typeof e=="string"))].sort():[],P=(r,e,t)=>Object.hasOwn(r?.services?.[e]??{},t);function D(r){if(!r||r.provider!==S)return"unsupported provider";if(typeof r.deviceId!="string"||!w.test(r.deviceId))return"invalid entity id";if(Object.hasOwn(r,"slot"))return"HA bindings require deviceId, not slot";let e=r.deviceId.split(".")[0];return O.has(e)?W[e].includes(r.capability)?null:"capability does not match entity domain":"unsupported domain"}function M(r,e="missing"){return{id:r,provider:S,name:null,deviceClass:null,availability:e,missing:e==="missing",power:null,light:null,contact:null,cover:null,climate:null,lock:null,cleaning:null,activity:null,safety:null,health:null,motion:null,controls:{}}}function X(r){let e=r.hs_color;if(Array.isArray(e)&&m(e[0])!==null&&m(e[1])!==null)return{hue:y(e[0],0,360)/360,saturation:y(e[1],0,100)/100};let t=r.rgb_color;if(!Array.isArray(t)||t.length!==3||t.some(d=>m(d)===null))return null;let[s,a,i]=t.map(d=>y(d,0,255)/255),o=Math.max(s,a,i),n=Math.min(s,a,i),l=o-n;return{hue:((l===0?0:o===s?(a-i)/l%6:o===a?(i-s)/l+2:(s-a)/l+4)/6+1)%1,saturation:o===0?0:l/o}}function N(r,e,t,s=[]){if(!e)return M(r);let a=r.split(".")[0],i=M(r,"unavailable"),o=e.attributes??{};if(i.name=typeof o.friendly_name=="string"?o.friendly_name:r,i.deviceClass=a,!w.test(r)||e.entity_id!==r||!O.has(a)||!s.some(c=>!D(c))||typeof e.state!="string"||["unknown","unavailable"].includes(e.state))return i;let n=e.state;i.availability="available";let l=c=>P(t,a,c),_=Number.isInteger(o.supported_features)?o.supported_features:0,d=c=>(_&c)===c,u=i.controls;if(a==="light"||a==="switch"){if(!["on","off"].includes(n))return{...i,availability:"unavailable"};if(i.power={isOn:n==="on"},u.setPower=l("turn_on")&&l("turn_off"),a==="light"){let c=L(o.supported_color_modes),f=c.some(b=>["brightness","color_temp","hs","xy","rgb","rgbw","rgbww","white"].includes(b)),g=c.some(b=>["hs","xy","rgb","rgbw","rgbww"].includes(b)),p=m(o.min_color_temp_kelvin),h=m(o.max_color_temp_kelvin);i.light={brightness:m(o.brightness)===null?null:y(o.brightness,0,255)/255,color:X(o),colorTemperatureKelvin:m(o.color_temp_kelvin),mode:o.color_mode==="color_temp"?"temperature":["hs","xy","rgb","rgbw","rgbww"].includes(o.color_mode)?"color":null},f&&l("turn_on")&&(u.setBrightness={min:0,max:1,step:1/255}),u.setColor=g&&l("turn_on"),c.includes("color_temp")&&p>0&&h>=p&&l("turn_on")&&(u.setColorTemperature={min:p,max:h,step:1,unit:"K"})}}else if(a==="cover")i.cover={position:m(o.current_position)===null?n==="closed"?0:null:y(o.current_position,0,100)/100,movement:["opening","closing"].includes(n)?n:["open","closed"].includes(n)?"stopped":"unknown"},u.openCover=d(1)&&l("open_cover"),u.closeCover=d(2)&&l("close_cover"),u.stopCover=d(8)&&l("stop_cover"),d(4)&&l("set_cover_position")&&(u.setCoverPosition={min:0,max:1,step:.01});else if(a==="climate"){let c=o.temperature_unit??t?.config?.unit_system?.temperature;i.climate={currentTemperature:m(o.current_temperature),targetTemperature:m(o.temperature),humidity:y(o.current_humidity,0,100),unit:["\xB0C","\xB0F"].includes(c)?c:null,mode:n,heatingActive:typeof o.hvac_action=="string"?o.hvac_action==="heating":null};let f=m(o.min_temp),g=m(o.max_temp);d(1)&&f!==null&&g!==null&&g>f&&l("set_temperature")&&i.climate.unit&&(u.setTargetTemperature={min:f,max:g,step:m(o.target_temp_step)>0?o.target_temp_step:.5,unit:i.climate.unit});let p=L(o.hvac_modes).filter(h=>["off","heat","cool","heat_cool","auto","dry","fan_only"].includes(h));p.length&&l("set_hvac_mode")&&(u.setThermostatMode={values:p.map(h=>({id:h,label:h}))})}else if(a==="lock"){i.lock={isLocked:n==="locked"?!0:n==="unlocked"?!1:null};let c=["locked","unlocked"].includes(n)&&!o.code_format;u.lock=c&&l("lock"),u.unlock=c&&l("unlock")}else if(a==="vacuum")i.cleaning={state:["cleaning","paused","returning","docked","idle","error"].includes(n)?n:"unknown",batteryPercent:y(o.battery_level,0,100),error:n==="error"?typeof o.error=="string"?o.error:"Device error":null},i.cleaning.batteryPercent!==null&&(i.health={batteryPercent:i.cleaning.batteryPercent,alerts:[]}),u.startCleaning=d(8192)&&l("start"),u.pauseCleaning=d(4)&&l("pause"),u.stopCleaning=d(8)&&l("stop"),u.returnToBase=d(16)&&l("return_to_base");else if(a==="binary_sensor"){let c=j[o.device_class];if(!c||!["on","off"].includes(n))return{...i,availability:"unavailable"};let[f,g,p]=c,h=p==="presence"?["occupancy"]:p==="smoke"?["smokeAlarm","alarm"]:p==="water"?["waterLeak","alarm"]:[p];if(!s.some(b=>h.includes(b.capability)))return{...i,availability:"unavailable"};i.deviceClass=f,g==="contact"?i.contact={state:n==="on"?"open":"closed"}:i[g]=[{id:p,baseId:p,active:n==="on",label:i.name}]}return i}function U(r,e,t,s){let a=r.id.split(".")[0],o=e?.type==="togglePower"?{type:"setPower",value:!r.power?.isOn}:e;if(typeof s!="function"||!s(r,o)||e?.type==="setCoverPosition"&&(e.value<0||e.value>1))throw new Error(`Unsupported action ${e?.type??"(missing)"} for ${r.id}.`);let n,l={entity_id:r.id};switch(e.type){case"togglePower":n="toggle";break;case"setPower":n=e.value?"turn_on":"turn_off";break;case"setBrightness":n="turn_on",l.brightness=Math.round(e.value*255);break;case"setColor":n="turn_on",l.hs_color=[e.value.hue*360,e.value.saturation*100];break;case"setColorTemperature":n="turn_on",l.color_temp_kelvin=Math.round(e.value);break;case"openCover":n="open_cover";break;case"closeCover":n="close_cover";break;case"stopCover":n="stop_cover";break;case"setCoverPosition":n="set_cover_position",l.position=Math.round(e.value*100);break;case"setTargetTemperature":n="set_temperature",l.temperature=e.value;break;case"setThermostatMode":n="set_hvac_mode",l.hvac_mode=e.value;break;case"lock":n="lock";break;case"unlock":n="unlock";break;case"startCleaning":n="start";break;case"pauseCleaning":n="pause";break;case"stopCleaning":n="stop";break;case"returnToBase":n="return_to_base";break;default:throw new Error("Unsupported action.")}if(!P(t,a,n))throw new Error(`Service ${a}.${n} is unavailable.`);return{domain:a,service:n,data:l}}var E=class{provider=S;bindings=new Map;states=new Map;listeners=new Set;disposed=!1;constructor(e=null,{supportsCommand:t=null}={}){this.hass=e,this.supportsCommand=t}configureCommandSupport(e){if(!this.disposed){if(typeof e!="function")throw new TypeError("A neutral command validator is required.");this.supportsCommand=e}}configureBindings(e){if(this.disposed)return;let t=new Map;for(let s of e??[])D(s)||t.set(s.deviceId,[...t.get(s.deviceId)??[],{...s}]);this.bindings=t;for(let s of this.states.keys())t.has(s)||this.states.delete(s);this.updateHass(this.hass)}normalize(e){let t=this.bindings.get(e);return t?N(e,this.hass?.states?.[e],this.hass,t):M(e,"unavailable")}updateHass(e){if(!this.disposed){this.hass=e;for(let t of this.bindings.keys()){let s=this.normalize(t);if(JSON.stringify(s)!==JSON.stringify(this.states.get(t))){this.states.set(t,s);for(let a of this.listeners)a(structuredClone(s))}}}}async loadStates(e){return this.disposed?[]:e.map(t=>structuredClone(this.states.get(t)??this.normalize(t)))}subscribe(e){return this.disposed?()=>{}:(this.listeners.add(e),()=>this.listeners.delete(e))}async execute(e,t){if(this.disposed)throw new Error("Home Assistant runtime has been disposed.");if(!this.bindings.has(e))throw new Error("Entity is not bound to this scene.");let s=this.normalize(e),{domain:a,service:i,data:o}=U(s,t,this.hass,this.supportsCommand);if(typeof this.hass?.callService!="function")throw new Error("Home Assistant is not connected.");return await this.hass.callService(a,i,o),{accepted:!0,deviceId:e,command:structuredClone(t)}}dispose(){this.disposed||(this.disposed=!0,this.listeners.clear(),this.states.clear(),this.bindings.clear(),this.hass=null,this.supportsCommand=null)}};var T="mikonus_dashboard/scene/",Y=[500,1e3,2e3,4e3,8e3],q=new Set(["unknown_command","integration_not_setup","disconnected","connection_lost","cannot_connect","timeout","transport_error","store_unavailable","storage_error"]),$={unknown_command:"Mikonus Dashboard unter Einstellungen \u2192 Ger\xE4te & Dienste hinzuf\xFCgen. Warte auf die Integration \u2026",integration_not_setup:"Mikonus Dashboard unter Einstellungen \u2192 Ger\xE4te & Dienste einrichten oder neu laden. Warte auf die Integration \u2026",scene_not_found:"Diese Scene wurde noch nicht aus Mikonus ver\xF6ffentlicht.",no_scenes:"Noch kein Dashboard ver\xF6ffentlicht. Ver\xF6ffentliche zuerst eine Scene aus Mikonus.",multiple_scenes:"Mehrere Dashboards vorhanden. Bitte scene_id in der Card-Konfiguration angeben.",invalid_scene_id:"Ung\xFCltige scene_id in der Card-Konfiguration.",invalid_scene:"Die ver\xF6ffentlichte Scene ist ung\xFCltig.",unauthorized:"Keine Berechtigung zum Laden dieses Dashboards.",permission_denied:"Keine Berechtigung zum Laden dieses Dashboards.",forbidden:"Keine Berechtigung zum Laden dieses Dashboards.",disconnected:"Verbindung zu Home Assistant unterbrochen."};function x(r){let e=typeof r=="number"?r:r?.code,t=[1,3].includes(e)?"disconnected":e;return Object.assign(new Error($[t]??r?.message??"Dashboard konnte nicht geladen werden."),{code:t})}function I(r){return q.has(x(r).code)||r?.name==="NetworkError"}var v=()=>new DOMException("Scene source stopped or superseded.","AbortError");function F(r,e){return e.throwIfAborted(),new Promise((t,s)=>{let a=()=>s(v());e.addEventListener("abort",a,{once:!0}),Promise.resolve(r).then(t,s).finally(()=>e.removeEventListener("abort",a))})}var A=r=>{try{Promise.resolve(r?.()).catch(()=>{})}catch{}},C=class{constructor(e,{sceneId:t,onStatus:s=()=>{},retryDelays:a=Y}={}){this.connection=e,this.sceneId=t,this.onStatus=s,this.revision=null,this.notifiedRevision=0,this.epoch=0,this.wakeRevision=0,this.transportGeneration=0,this.listeners=new Set,this.disposed=!1,this.unsubscribe=null,this.starting=null,this.pending=null,this.unavailable=!1,this.observers=new Map,this.retryDelays=a,this.retryIndex=0,this.timer=null,this.lifetime=new AbortController,this.transport=new AbortController,this.onDisconnect=()=>{this.disposed||(this.unavailable=!0,this.invalidate(),this.clearRetry(),this.onStatus(x({code:"disconnected"})))},this.onReconnect=()=>{this.disposed||(this.invalidate(),this.recover())},e?.addEventListener?.("disconnected",this.onDisconnect),e?.addEventListener?.("ready",this.onReconnect)}clearRetry(){clearTimeout(this.timer),this.timer=null}retry(e){this.disposed||!I(e)||this.timer!==null||this.connection?.connected===!1||this.retryIndex>=this.retryDelays.length||(this.timer=setTimeout(()=>{this.timer=null,this.wake()},this.retryDelays[this.retryIndex++]))}wake(){this.disposed||this.emit({revision:`recovery:${++this.wakeRevision}:${this.epoch}`})}recover(){this.clearRetry(),this.retryIndex=0,this.unavailable=!1,this.wake()}invalidate(){this.transport.abort(),this.transport=new AbortController,++this.epoch,++this.transportGeneration,this.pending=null,this.starting=null,this.revision=null,this.notifiedRevision=0,A(this.unsubscribe),this.unsubscribe=null;for(let e of this.observers.values())A(e.unsubscribe);this.observers.clear()}async observe(e,t,s){if(this.observers.has(e))return this.observers.get(e).promise;let a={};return this.observers.set(e,a),a.promise=this.connection.subscribeMessage(i=>{!this.disposed&&this.observers.get(e)===a&&s(i)},t,{resubscribe:!1}).then(i=>{if(this.disposed||this.observers.get(e)!==a)throw A(i),v();a.unsubscribe=i}).catch(i=>{throw this.observers.get(e)===a&&this.observers.delete(e),i}),a.promise}async start(){if(this.starting)return this.starting;let e=this.epoch,t=(async()=>{if(typeof this.connection?.sendMessagePromise!="function"||typeof this.connection?.subscribeMessage!="function"||this.connection.connected===!1)throw x({code:"disconnected"});if(await this.observe("component",{type:"subscribe_events",event_type:"component_loaded"},i=>{i.data?.component==="mikonus_dashboard"&&this.recover()}),await this.observe("watch",{type:T+"watch"},i=>{(i.type==="ready"||i.type==="updated"&&!this.unsubscribe&&(!this.sceneId||i.sceneId===this.sceneId))&&this.recover()}),!this.sceneId){let{scenes:i}=await this.connection.sendMessagePromise({type:T+"list"});if(this.disposed||e!==this.epoch)throw v();if(!i.length)throw x({code:"no_scenes"});if(i.length!==1)throw x({code:"multiple_scenes"});this.sceneId=i[0].sceneId}if(this.disposed||e!==this.epoch)throw v();if(this.unsubscribe)return;let s=this.transportGeneration,a=await this.connection.subscribeMessage(i=>{s===this.transportGeneration&&this.onEvent(i)},{type:T+"subscribe",scene_id:this.sceneId},{resubscribe:!1});if(this.disposed||e!==this.epoch)throw A(a),v();this.unsubscribe=a})();this.starting=t;try{return await t}finally{this.starting===t&&(this.starting=null)}}onEvent(e){if(!this.disposed){if(e.type==="unavailable"){this.unavailable=!0,this.onStatus(x(e)),I(e)||this.clearRetry(),this.retry(e);return}e.sceneId!==this.sceneId||!Number.isSafeInteger(e.revision)||(this.unavailable&&(this.unavailable=!1,this.revision=null,this.notifiedRevision=0,++this.epoch),!(e.revision<=(this.revision??0)||e.revision<=this.notifiedRevision)&&(this.notifiedRevision=e.revision,this.clearRetry(),this.retryIndex=0,this.listeners.size&&this.emit({sceneId:this.sceneId,revision:`${e.revision}:${this.epoch}`})))}}emit(e){for(let t of this.listeners)t(e)}async loadScene({signal:e}={}){if(e?.throwIfAborted(),this.disposed)throw v();let t=this.epoch,s=AbortSignal.any([this.lifetime.signal,this.transport.signal,...e?[e]:[]]);try{if(await F(this.start(),s),e?.throwIfAborted(),this.disposed||t!==this.epoch)throw v();this.pending??=this.connection.sendMessagePromise({type:T+"get",scene_id:this.sceneId});let a=this.pending,i;try{i=await F(a,s)}finally{this.pending===a&&(this.pending=null)}if(e?.throwIfAborted(),this.disposed||t!==this.epoch)throw v();let o=i?.metadata?.revision;if(i?.scene?.sceneId!==this.sceneId||!Number.isSafeInteger(o)||o<1)throw x({code:"invalid_scene"});return this.revision=o,this.clearRetry(),this.retryIndex=0,this.onStatus(null),{scene:i.scene,metadata:{...i.metadata,revision:`${o}:${t}`,source:"homeAssistant"}}}catch(a){if(this.disposed||t!==this.epoch||a?.name==="AbortError")throw v();let i=x(a);throw this.onStatus(i),I(a)||this.clearRetry(),this.retry(a),i}}async waitUntilReady({signal:e}={}){let t=[this.lifetime.signal,...e?[e]:[]],s=!0,a,i=()=>{s=!0,a?.()},o=this.subscribe(i);for(let n of t)n.addEventListener("abort",i);try{for(;;){for(let n of t)n.throwIfAborted();s||await new Promise(n=>{a=n}),a=null;for(let n of t)n.throwIfAborted();s=!1;try{return await this.loadScene({signal:e})}catch{if(this.disposed||e?.aborted)throw v()}}}finally{o();for(let n of t)n.removeEventListener("abort",i)}}subscribe(e){return this.disposed?()=>{}:(this.listeners.add(e),this.notifiedRevision>(this.revision??0)&&e({sceneId:this.sceneId,revision:`${this.notifiedRevision}:${this.epoch}`}),()=>this.listeners.delete(e))}dispose(){this.disposed||(this.disposed=!0,this.lifetime.abort(),this.clearRetry(),this.invalidate(),this.listeners.clear(),this.connection?.removeEventListener?.("disconnected",this.onDisconnect),this.connection?.removeEventListener?.("ready",this.onReconnect))}};var k={schemaVersion:2,sceneId:"mikonus:ha-reference",name:"Mikonus HA Reference",metadata:{generator:"mikonus-ha-development-fixture",revision:"1"},defaultFloorId:"floor-eg",floors:[{id:"floor-ug",name:"UG",level:-1,sortOrder:0,elevation:-2.8,rooms:[{id:"room-ug-storage",name:"Keller",polygon:[{x:-2.4,z:-1.8},{x:2.4,z:-1.8},{x:2.4,z:1.8},{x:-2.4,z:1.8}],elevation:0,floorThickness:.2,appearance:"floor"}],walls:[],doors:[],windows:[],objects:[{id:"object-ug-storage",kind:"furniture",shape:"box",position:{x:0,y:.45,z:0},rotation:{y:0},size:{width:1.2,depth:.6,height:.9},appearance:"cabinet"}]},{id:"floor-eg",name:"EG",level:0,sortOrder:1,elevation:0,rooms:[{id:"room-eg-living",name:"Wohnzimmer",polygon:[{x:-3.2,z:-2.4},{x:3.2,z:-2.4},{x:3.2,z:2.4},{x:-3.2,z:2.4}],elevation:0,floorThickness:.2,appearance:"floor"}],walls:[{id:"wall-eg-north",start:{x:-3.2,z:-2.4},end:{x:3.2,z:-2.4},baseY:0,height:2.8,thickness:.15}],doors:[],windows:[{id:"cover-eg-window",wallId:"wall-eg-north",position:{x:0,y:.7,z:-2.4},rotation:{y:0},size:{width:1.8,height:1.7,depth:.08},openAngle:0,binding:{provider:"homeAssistant",deviceId:"cover.mikonus_reference",capability:"position"}}],objects:[{id:"light-eg-living",kind:"light",position:{x:-.8,y:2.35,z:.4},rotation:{y:0},size:{width:.42,depth:.42,height:.16},visualType:"ceilingLight",appearance:"ceiling-light",binding:{provider:"homeAssistant",deviceId:"light.mikonus_reference",capability:"power"}}]},{id:"floor-og",name:"OG",level:1,sortOrder:2,elevation:2.8,rooms:[{id:"room-og-bedroom",name:"Schlafzimmer",polygon:[{x:-2.8,z:-2.1},{x:2.8,z:-2.1},{x:2.8,z:2.1},{x:-2.8,z:2.1}],elevation:0,floorThickness:.2,appearance:"floor"}],walls:[],doors:[],windows:[],objects:[{id:"light-og-bedroom",kind:"light",position:{x:.9,y:2.35,z:-.3},rotation:{y:0},size:{width:.38,depth:.38,height:.14},visualType:"ceilingLight",appearance:"ceiling-light",binding:{provider:"homeAssistant",deviceId:"light.mikonus_upstairs",capability:"power"}}]}]};var Z={"light.mikonus_reference":"light","light.mikonus_upstairs":"upstairs_light","cover.mikonus_reference":"cover"};function z(r={}){let e=structuredClone(k);for(let t of e.floors)for(let s of["objects","doors","windows"])for(let a of t[s])a.binding&&(a.binding.deviceId=r[Z[a.binding.deviceId]]??a.binding.deviceId);return e}function B(r){if(!r||r.type!=="custom:mikonus-3d-card")throw new Error("Expected type: custom:mikonus-3d-card.");if(r.scene==="published"){if(r.scene_id!==void 0&&(typeof r.scene_id!="string"||!/^mikonus:[A-Za-z0-9][A-Za-z0-9:_-]{0,190}$/.test(r.scene_id)))throw new Error("Invalid scene_id.");if(r.entities!==void 0)throw new Error("entities applies only to scene: reference.");return{type:"custom:mikonus-3d-card",scene:"published",...r.scene_id?{scene_id:r.scene_id}:{}}}if(r.scene!==void 0&&r.scene!=="reference")throw new Error("Expected scene: reference or published.");if(r.scene_id!==void 0)throw new Error("scene_id requires scene: published.");let e=r.entities??{};if(!e||typeof e!="object"||Array.isArray(e))throw new Error("entities must be a mapping.");let t={};for(let s of Object.keys(e).sort()){let a={light:"light",upstairs_light:"light",cover:"cover"}[s],i=e[s];if(!a||typeof i!="string"||!w.test(i)||!i.startsWith(`${a}.`))throw new Error(`Invalid reference entity mapping: ${s}.`);t[s]=i}return{type:"custom:mikonus-3d-card",scene:"reference",entities:t}}function V(r){return class extends HTMLElement{#e=null;#t=null;#l=null;#n=null;#r=0;#c=new Map;#i=null;#h=t=>{t.persisted&&(this.#o(),this.#s())};constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML='<style>:host{display:block;height:100%;min-height:360px}.card{position:relative;height:100%;min-height:360px;border-radius:var(--ha-card-border-radius,12px);overflow:hidden;background:var(--ha-card-background,var(--card-background-color,#fff))}.viewport{height:100%;min-height:360px}p{position:absolute;inset:16px auto auto 16px;margin:0;max-width:calc(100% - 32px);font:14px system-ui;color:var(--primary-text-color,#222)}[hidden]{display:none}</style><div class="card"><div class="viewport"></div><p role="status">Warte auf Home Assistant \u2026</p></div>'}setConfig(t){let s=B(t);JSON.stringify(s)!==JSON.stringify(this.#e)&&(this.#e=s,this.#o(),this.#s())}set hass(t){let s=this.#t&&this.#t.connection!==t?.connection;this.#t=t,s&&this.#e?.scene==="published"&&this.#o(),this.#n?.updateHass(t),this.#s()}get hass(){return this.#t}connectedCallback(){window.addEventListener("pageshow",this.#h),this.#s()}disconnectedCallback(){window.removeEventListener("pageshow",this.#h),this.#o()}getCardSize(){return 8}getGridOptions(){return{columns:12,rows:7,min_columns:6,min_rows:6}}static getStubConfig(){return{scene:"reference"}}#a(t){let s=this.shadowRoot.querySelector("[role=status]");s.textContent=t,s.hidden=!t}#s(){if(!this.isConnected||!this.#e||!this.#t||this.#n)return;let t=++this.#r,s=new E(this.#t);this.#n=s,this.#a("Mikonus wird geladen \u2026");let a=this.#c,i={getItem:o=>a.get(o)??null,setItem:(o,n)=>a.set(o,String(n)),removeItem:o=>a.delete(o)};this.#e.scene==="published"&&(this.#i=new C(this.#t.connection,{sceneId:this.#e.scene_id,onStatus:o=>{t===this.#r&&this.#a(o?.message??"")}}));try{let o=r({container:this.shadowRoot.querySelector(".viewport"),runtime:s,scene:this.#i?void 0:z(this.#e.entities),sceneSource:this.#i,storage:i,onReady:()=>{t===this.#r&&this.#a("")},onError:n=>{t===this.#r&&(s.dispose(),this.#i?.dispose(),this.#a(`Mikonus konnte nicht geladen werden: ${n.message??"Unbekannter Fehler"}`))}});t!==this.#r?o.dispose():this.#l=o}catch(o){s.dispose(),this.#i?.dispose(),this.#a(`Mikonus konnte nicht geladen werden: ${o.message}`)}}#o(){++this.#r;try{this.#l?.dispose()}finally{this.#i?.dispose(),this.#i=null,this.#n?.dispose(),this.#n=null,this.#l=null,this.shadowRoot.querySelector(".viewport").replaceChildren()}}}}var H=`(()=>{var W0=Object.create;var ad=Object.defineProperty;var X0=Object.getOwnPropertyDescriptor;var q0=Object.getOwnPropertyNames;var Y0=Object.getPrototypeOf,$0=Object.prototype.hasOwnProperty;var Ka=(n,e)=>()=>{try{return e||n((e={exports:{}}).exports,e),e.exports}catch(t){throw e=0,t}};var j0=(n,e,t,i)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of q0(e))!$0.call(n,s)&&s!==t&&ad(n,s,{get:()=>e[s],enumerable:!(i=X0(e,s))||i.enumerable});return n};var ei=(n,e,t)=>(t=n!=null?W0(Y0(n)):{},j0(e||!n||!n.__esModule?ad(t,"default",{value:n,enumerable:!0}):t,n));var Dl=Ka((Ow,od)=>{"use strict";function os(n,e){return\`\${n}:\${e}\`}function Fs(n){let e=n.end.x-n.start.x,t=n.end.z-n.start.z,i=Math.hypot(e,t);if(!Number.isFinite(i)||i<=0)throw new TypeError(\`Wall \${n.id??"<unknown>"} must have a positive length.\`);return{length:i,direction:{x:e/i,z:t/i},perpendicular:{x:-t/i,z:e/i}}}function Pl(n,e,t){let i=Fs(n),s=e.rotation.y*Math.PI/180,r={x:Math.cos(s),z:-Math.sin(s)},a={x:e.position.x+r.x*e.size.width/2,z:e.position.z+r.z*e.size.width/2},o=(a.x-n.start.x)*i.direction.x+(a.z-n.start.z)*i.direction.z,c=t==="door"?0:e.position.y-n.baseY;return{id:e.id,kind:t,wallId:n.id,centerOffset:o,minimumOffset:o-e.size.width/2,maximumOffset:o+e.size.width/2,minimumY:c,maximumY:c+e.size.height,width:e.size.width,height:e.size.height}}function Z0(n,e){return[...n.doors.filter(t=>t.wallId===e.id).map(t=>Pl(e,t,"door")),...n.windows.filter(t=>t.wallId===e.id).map(t=>Pl(e,t,"window"))].sort((t,i)=>t.minimumOffset-i.minimumOffset||t.minimumY-i.minimumY||t.id.localeCompare(i.id))}function K0(n,e,t){let i=Math.max(0,Math.min(n.minimumOffset,e)),s=Math.max(0,Math.min(n.maximumOffset,e)),r=Math.max(0,Math.min(n.minimumY,t)),a=Math.max(0,Math.min(n.maximumY,t));return s-i<.001||a-r<.001?null:{minimumOffset:i,maximumOffset:s,minimumY:r,maximumY:a}}function J0(n){let e=[...n].sort((i,s)=>i-s),t=[];for(let i of e)(t.length===0||Math.abs(i-t[t.length-1])>=.001)&&t.push(i);return t}function Q0(n,e){let{length:t}=Fs(n),i=e.map(a=>K0(a,t,n.height)).filter(Boolean);if(i.length===0)return[{minimumOffset:0,maximumOffset:t,minimumY:0,maximumY:n.height,width:t,height:n.height,centerOffset:t/2,centerY:n.height/2}];let s=J0(new Set([0,t,...i.flatMap(a=>[a.minimumOffset,a.maximumOffset])])),r=[];for(let a=1;a<s.length;a+=1){let o=s[a-1],c=s[a];if(c-o<.001)continue;let l=(o+c)/2,u=i.filter(d=>l>=d.minimumOffset-.001&&l<=d.maximumOffset+.001).map(d=>[d.minimumY,d.maximumY]).sort((d,p)=>d[0]-p[0]),h=[];for(let d of u){let p=h[h.length-1];p&&d[0]<=p[1]+.001?p[1]=Math.max(p[1],d[1]):h.push([...d])}let f=0;for(let d of h)d[0]-f>=.001&&r.push(Fr(o,c,f,d[0])),f=Math.max(f,d[1]);n.height-f>=.001&&r.push(Fr(o,c,f,n.height))}return r}function Fr(n,e,t,i){return{minimumOffset:n,maximumOffset:e,minimumY:t,maximumY:i,width:e-n,height:i-t,centerOffset:(n+e)/2,centerY:(t+i)/2}}function eg(n,e,t=1.38,i=.04){let s=n.minimumY<=.002,r=n.maximumY<e-.002,a=null;s&&r?a=n.maximumY:s&&(a=Math.min(n.maximumY,Math.max(t,i)));let o=[],c=[];return a!==null&&a-n.minimumY>=i?(o.push(Fr(n.minimumOffset,n.maximumOffset,n.minimumY,a)),n.maximumY-a>=i&&c.push(Fr(n.minimumOffset,n.maximumOffset,a,n.maximumY))):c.push(n),{visiblePanels:o,lightOccluderPanels:c}}function tg(n,e,t=.01){let i=Math.min(n.maximumOffset,e.maximumOffset)-Math.max(n.minimumOffset,e.minimumOffset),s=Math.min(n.maximumY,e.maximumY)-Math.max(n.minimumY,e.minimumY);return i>t&&s>t}function ng(n,e=.11){let t=n.flatMap((d,p)=>{let x=Fs(d);return[{wall:d,wallIndex:p,end:"start",point:d.start,inward:x.direction},{wall:d,wallIndex:p,end:"end",point:d.end,inward:{x:-x.direction.x,z:-x.direction.z}}]}),i=t.map((d,p)=>p),s=d=>{let p=d;for(;i[p]!==p;)p=i[p];return p},r=(d,p)=>{let x=s(d),m=s(p);x!==m&&(i[m]=x)},a=e*e;for(let d=0;d<t.length;d+=1)for(let p=d+1;p<t.length;p+=1){let x=t[d],m=t[p];if(x.wall.id===m.wall.id||Math.abs(x.wall.baseY-m.wall.baseY)>e)continue;let g=x.point.x-m.point.x,w=x.point.z-m.point.z;g*g+w*w<=a&&r(d,p)}let o=new Map;t.forEach((d,p)=>{let x=s(p);o.has(x)||o.set(x,[]),o.get(x).push(p)});let c=new Set,l=new Set,u=new Set,h=new Map,f=[];for(let d of o.values()){if(new Set(d.map(E=>t[E].wall.id)).size<2||(d.forEach(E=>c.add(os(t[E].wall.id,t[E].end))),d.length!==2))continue;let p=t[d[0]],x=t[d[1]],m=p.inward.x*x.inward.x+p.inward.z*x.inward.z,g=p.inward.x*x.inward.z-p.inward.z*x.inward.x,w={x:(p.point.x+x.point.x)/2,z:(p.point.z+x.point.z)/2};if(Math.abs(m)<=.2&&Math.abs(g)>=.96){g<0&&([p,x]=[x,p]);let E=Math.max(p.wall.thickness,x.wall.thickness),y=E/2,T={x:w.x+(p.inward.x+x.inward.x)*y,z:w.z+(p.inward.z+x.inward.z)*y},b={center:w,arcCenter:T,first:p,second:x,thickness:E,elevation:(p.wall.baseY+x.wall.baseY)/2,height:Math.min(p.wall.height,x.wall.height)};f.push(b),l.add(os(p.wall.id,p.end)),l.add(os(x.wall.id,x.end))}else if(m<=-.98&&Math.abs(g)<=.08)for(let E of[p,x]){let y=os(E.wall.id,E.end),T={x:-E.inward.x,z:-E.inward.z};u.add(y),h.set(y,(w.x-E.point.x)*T.x+(w.z-E.point.z)*T.z)}}return t.forEach(d=>{let p=os(d.wall.id,d.end);if(!c.has(p))for(let x of n){if(x.id===d.wall.id||Math.abs(x.baseY-d.wall.baseY)>e)continue;let m=Fs(x),g=d.point.x-x.start.x,w=d.point.z-x.start.z,E=(g*m.direction.x+w*m.direction.z)/m.length;if(E<=.03||E>=.97)continue;let y={x:x.start.x+m.direction.x*m.length*E,z:x.start.z+m.direction.z*m.length*E},T=d.point.x-y.x,b=d.point.z-y.z;if(T*T+b*b<=a){c.add(p);break}}}),f.sort((d,p)=>d.center.x-p.center.x||d.center.z-p.center.z),{joinedEndpoints:c,roundedEndpoints:l,continuationEndpoints:u,continuationAlignmentOffsets:h,roundedCorners:f}}function ig(n,e=0,t=16){let i=Math.max(Math.round(t),4),s=Math.max(n.thickness+Math.max(e,0),.001),r=[{...n.arcCenter}];for(let a=i;a>=0;a-=1){let o=a/i*Math.PI/2;r.push({x:n.arcCenter.x-n.first.inward.x*Math.sin(o)*s-n.second.inward.x*Math.cos(o)*s,z:n.arcCenter.z-n.first.inward.z*Math.sin(o)*s-n.second.inward.z*Math.cos(o)*s})}return r}function sg(n,e,t){let i=Fs(e),s=Math.abs(n.minimumOffset)<=.003,r=Math.abs(n.maximumOffset-i.length)<=.003,a=os(e.id,"start"),o=os(e.id,"end"),c=e.thickness/2,l=n.minimumOffset,u=n.maximumOffset;if(s&&(t.roundedEndpoints.has(a)?l+=c:t.continuationEndpoints.has(a)?l-=t.continuationAlignmentOffsets?.get(a)??0:t.joinedEndpoints.has(a)&&(l-=c)),r&&(t.roundedEndpoints.has(o)?u-=c:t.continuationEndpoints.has(o)?u+=t.continuationAlignmentOffsets?.get(o)??0:t.joinedEndpoints.has(o)&&(u+=c)),u-l<.012){let f=(n.minimumOffset+n.maximumOffset)/2;l=f-.006,u=f+.006}return Fr(l,u,n.minimumY,n.maximumY)}od.exports={DOLLHOUSE_WALL_HEIGHT:1.38,MINIMUM_PANEL_SIZE:.001,OPENING_OVERLAP_EPSILON:.01,PRESENTATION_MINIMUM_PANEL_SIZE:.04,WALL_CORNER_SEGMENTS:16,WALL_JOIN_TOLERANCE:.11,buildWallPanels:Q0,collectWallOpenings:Z0,contactOpening:Pl,openingsOverlap:tg,joinedWallPanel:sg,resolveWallPresentation:eg,resolveWallJoinTopology:ng,roundedCornerFootprint:ig,wallFrame:Fs}});var _d=Ka((Nw,vd)=>{"use strict";var{contactOpening:rg,openingsOverlap:ag,wallFrame:og}=Dl(),Ol=Object.freeze([1,2]),cg=2,lg=new Set(["light","furniture","decor"]),Qa=new Set(["box","cylinder","ellipsoid"]),eo=.1,to=Object.freeze({maxJsonBytes:2*1024*1024,maxFloors:16,maxRooms:256,maxWalls:4096,maxDoors:1024,maxWindows:2048,maxObjects:8192,maxPolygonPointsPerRoom:1024}),Us=class extends Error{constructor(e,t){super(e,t),this.name="DashboardSceneError",this.code="invalid_dashboard_scene"}};function ht(n,e){throw new Us(\`\${n}: \${e}\`)}function Li(n){return n!==null&&typeof n=="object"&&!Array.isArray(n)}function Vt(n,e){Li(n)||ht(e,"must be an object.")}function cs(n,e){Array.isArray(n)||ht(e,"must be an array.")}function Ct(n,e){(typeof n!="string"||n.trim().length===0)&&ht(e,"must be a non-empty string.")}function Bt(n,e,{positive:t=!1}={}){Number.isFinite(n)||ht(e,"must be a finite number."),t&&n<=0&&ht(e,"must be greater than zero.")}function cd(n,e,{nonNegative:t=!1}={}){Bt(n,e),Number.isInteger(n)||ht(e,"must be an integer."),t&&n<0&&ht(e,"must be zero or greater.")}function Ll(n,e){Bt(n,e),(n<0||n>1)&&ht(e,"must be between zero and one.")}function dd(n){return typeof TextEncoder=="function"?new TextEncoder().encode(n).byteLength:typeof Buffer<"u"?Buffer.byteLength(n,"utf8"):unescape(encodeURIComponent(n)).length}function ug(n){let e;try{e=JSON.stringify(n)}catch(t){throw new Us("scene: must be JSON serializable.",{cause:t})}return typeof e!="string"&&ht("scene","must be a JSON object."),dd(e)}function ls(n,e,t){e>t&&ht(n,\`contains \${e} entries; maximum is \${t}.\`)}function Nl(n,e){Vt(n,e),Bt(n.x,\`\${e}.x\`),Bt(n.z,\`\${e}.z\`)}function fd(n,e){Vt(n,e),Bt(n.x,\`\${e}.x\`),Bt(n.y,\`\${e}.y\`),Bt(n.z,\`\${e}.z\`)}function pd(n,e){Vt(n,e),Bt(n.y,\`\${e}.y\`)}function Fl(n,e){Vt(n,e),Bt(n.width,\`\${e}.width\`,{positive:!0}),Bt(n.depth,\`\${e}.depth\`,{positive:!0}),Bt(n.height,\`\${e}.height\`,{positive:!0})}function md(n,e){if(typeof n>"u")return;Vt(n,e),Ct(n.provider,\`\${e}.provider\`),Ct(n.capability,\`\${e}.capability\`);let t=typeof n.deviceId<"u",i=typeof n.slot<"u";t===i&&ht(e,"must contain exactly one of deviceId or slot."),t&&Ct(n.deviceId,\`\${e}.deviceId\`),i&&Ct(n.slot,\`\${e}.slot\`)}function no(n,e){typeof n<"u"&&Ct(n,e)}function hg(n,e){if(!(typeof n>"u")){Vt(n,e),Vt(n.materialSlots,\`\${e}.materialSlots\`);for(let[t,i]of Object.entries(n.materialSlots)){Ct(t,\`\${e}.materialSlots key\`);let s=\`\${e}.materialSlots.\${t}\`;Di(i,s)}}}function Di(n,e){typeof n>"u"||(Vt(n,e),Ct(n.materialKey,\`\${e}.materialKey\`),(typeof n.baseColor!="string"||!/^#[0-9A-Fa-f]{6}$/.test(n.baseColor))&&ht(\`\${e}.baseColor\`,"must be an RGB hex color."),Ll(n.roughness,\`\${e}.roughness\`),Ll(n.metallic,\`\${e}.metallic\`),Ll(n.opacity,\`\${e}.opacity\`),typeof n.pattern<"u"&&(Vt(n.pattern,\`\${e}.pattern\`),Ct(n.pattern.kind,\`\${e}.pattern.kind\`),Bt(n.pattern.elementSize,\`\${e}.pattern.elementSize\`,{positive:!0}),Bt(n.pattern.lineWidth,\`\${e}.pattern.lineWidth\`,{positive:!0}),Ct(n.pattern.orientation,\`\${e}.pattern.orientation\`)))}function dg(n,e){typeof n>"u"||(Vt(n,e),Di(n.body,\`\${e}.body\`),Di(n.positiveSide,\`\${e}.positiveSide\`),Di(n.negativeSide,\`\${e}.negativeSide\`))}function fg(n,e){typeof n>"u"||(Vt(n,e),Di(n.panel,\`\${e}.panel\`),Di(n.frame,\`\${e}.frame\`),Di(n.reveal,\`\${e}.reveal\`))}function pg(n,e){if(!(typeof n>"u")){Vt(n,e);for(let[t,i]of Object.entries(n))Ct(t,\`\${e} key\`),typeof i!="string"&&typeof i!="boolean"&&!Number.isFinite(i)&&ht(\`\${e}.\${t}\`,"must be a finite number, string, or boolean.")}}function Ur(n,e,t){Ct(n,e),t.has(n)&&ht(e,\`duplicate scene id "\${n}".\`),t.add(n)}function mg(n){return Li(n)?{...n,elevation:n.elevation??0,floorThickness:n.floorThickness??.2,appearance:n.appearance??"floor"}:n}function gg(n){return Li(n)?{...n,baseY:n.baseY??0,appearance:n.appearance??"wall"}:n}function gd(n){return n==null?{y:0}:Li(n)?{...n,y:n.y??0}:n}function ld(n,e){return Li(n)?{...n,rotation:gd(n.rotation),openAngle:n.openAngle??70,appearance:n.appearance??e}:n}function xg(n){if(!Li(n))return n;let e=n.appearance==="floor-lamp"?"floorLamp":n.appearance==="table-lamp"?"tableLamp":"floorLamp";return{...n,rotation:gd(n.rotation),visualType:n.visualType??(n.kind==="light"?e:void 0),appearance:n.appearance??(n.assetKey?{materialSlots:{}}:n.kind)}}function vg(n,e,t){if(!Li(n))return n;let i={...n,rooms:Array.isArray(n.rooms)?n.rooms.map(mg):n.rooms??[],walls:Array.isArray(n.walls)?n.walls.map(gg):n.walls??[],doors:Array.isArray(n.doors)?n.doors.map(s=>ld(s,"door")):n.doors??[],windows:Array.isArray(n.windows)?n.windows.map(s=>ld(s,"window")):n.windows??[],objects:Array.isArray(n.objects)?n.objects.map(xg):n.objects??[]};return e!==1?i:{...i,level:0,sortOrder:t,elevation:0}}function _g(n,e){let t=n.sortOrder-e.sortOrder;if(t!==0)return t;let i=n.level-e.level;return i!==0?i:n.id<e.id?-1:n.id>e.id?1:0}function yg(n,e,t,i){Vt(n,e),Ur(n.id,\`\${e}.id\`,t),Ct(n.name,\`\${e}.name\`),cs(n.polygon,\`\${e}.polygon\`),n.polygon.length<3&&ht(\`\${e}.polygon\`,"must contain at least three points."),ls(\`\${e}.polygon\`,n.polygon.length,i.maxPolygonPointsPerRoom),n.polygon.forEach((s,r)=>Nl(s,\`\${e}.polygon[\${r}]\`)),Bt(n.elevation,\`\${e}.elevation\`),Bt(n.floorThickness,\`\${e}.floorThickness\`,{positive:!0}),no(n.appearance,\`\${e}.appearance\`),Di(n.material,\`\${e}.material\`)}function bg(n,e,t){Vt(n,e),Ur(n.id,\`\${e}.id\`,t),Nl(n.start,\`\${e}.start\`),Nl(n.end,\`\${e}.end\`),n.start.x===n.end.x&&n.start.z===n.end.z&&ht(e,"start and end must describe a wall with non-zero length."),Bt(n.baseY,\`\${e}.baseY\`),Bt(n.height,\`\${e}.height\`,{positive:!0}),Bt(n.thickness,\`\${e}.thickness\`,{positive:!0}),no(n.appearance,\`\${e}.appearance\`),dg(n.materials,\`\${e}.materials\`)}function ud(n,e,t){Vt(n,e),Ur(n.id,\`\${e}.id\`,t),typeof n.wallId<"u"&&Ct(n.wallId,\`\${e}.wallId\`),fd(n.position,\`\${e}.position\`),pd(n.rotation,\`\${e}.rotation\`),Fl(n.size,\`\${e}.size\`),Bt(n.openAngle,\`\${e}.openAngle\`),no(n.appearance,\`\${e}.appearance\`),fg(n.materials,\`\${e}.materials\`),md(n.binding,\`\${e}.binding\`)}function hd(n,e,t,i){let s=rg(e,n,t),{length:r}=og(e);return(s.minimumOffset<-eo||s.maximumOffset>r+eo)&&ht(i,"opening must lie within its referenced wall."),t==="window"&&s.minimumY<-eo&&ht(\`\${i}.position.y\`,"window sill must not be below its referenced wall."),s.maximumY>e.height+eo&&ht(i,"opening height must lie within its referenced wall."),s}function Mg(n){for(let e=0;e<n.length;e+=1)for(let t=e+1;t<n.length;t+=1)ag(n[e].opening,n[t].opening)&&ht(n[t].path,"opening overlaps another opening in the same wall.")}function Sg(n,e,t){Vt(n,e),Ur(n.id,\`\${e}.id\`,t),Ct(n.kind,\`\${e}.kind\`),lg.has(n.kind)||ht(\`\${e}.kind\`,"must be light, furniture, or decor."),fd(n.position,\`\${e}.position\`),pd(n.rotation,\`\${e}.rotation\`),Fl(n.size,\`\${e}.size\`),md(n.binding,\`\${e}.binding\`),typeof n.visualType<"u"&&Ct(n.visualType,\`\${e}.visualType\`),pg(n.parameters,\`\${e}.parameters\`),typeof n.assetKey<"u"?(Ct(n.assetKey,\`\${e}.assetKey\`),n.kind!=="furniture"&&n.kind!=="decor"&&ht(\`\${e}.kind\`,"an assetKey is only valid for furniture or decor."),typeof n.variantKey<"u"?Ct(n.variantKey,\`\${e}.variantKey\`):ht(\`\${e}.variantKey\`,"must be a non-empty string."),Fl(n.dimensions,\`\${e}.dimensions\`),hg(n.appearance,\`\${e}.appearance\`)):no(n.appearance,\`\${e}.appearance\`),n.kind!=="light"&&typeof n.assetKey>"u"?(Ct(n.shape,\`\${e}.shape\`),Qa.has(n.shape)||ht(\`\${e}.shape\`,\`must be one of \${[...Qa].join(", ")}.\`)):typeof n.shape<"u"&&!Qa.has(n.shape)&&ht(\`\${e}.shape\`,\`must be one of \${[...Qa].join(", ")} when provided.\`)}function Eg(n){Vt(n,"metadata"),typeof n.generatedAt<"u"&&Ct(n.generatedAt,"metadata.generatedAt"),typeof n.generator<"u"&&Ct(n.generator,"metadata.generator"),typeof n.revision<"u"&&Ct(n.revision,"metadata.revision")}function xd(n,{limits:e=to}={}){let t={...to,...e};Vt(n,"scene");let i=ug(n);i>t.maxJsonBytes&&ht("scene",\`JSON size is \${i} bytes; maximum is \${t.maxJsonBytes} bytes.\`),Ol.includes(n.schemaVersion)||ht("schemaVersion",\`unsupported version \${String(n.schemaVersion)}; expected one of \${Ol.join(", ")}.\`),Ct(n.sceneId,"sceneId"),Ct(n.name,"name"),cs(n.floors,"floors"),n.floors.length===0&&ht("floors","must contain at least one floor."),ls("floors",n.floors.length,t.maxFloors),n.schemaVersion===2&&(Ct(n.defaultFloorId,"defaultFloorId"),typeof n.activeFloorId<"u"&&ht("activeFloorId","must not be stored in a Dashboard Scene v2."));let s={...n,metadata:n.metadata??{},defaultFloorId:n.schemaVersion===1?n.floors[0]?.id:n.defaultFloorId,floors:Array.isArray(n.floors)?n.floors.map((l,u)=>vg(l,n.schemaVersion,u)):n.floors};Eg(s.metadata);let r={rooms:0,walls:0,doors:0,windows:0,objects:0};for(let l of s.floors)if(Li(l))for(let u of Object.keys(r))Array.isArray(l[u])&&(r[u]+=l[u].length);ls("rooms",r.rooms,t.maxRooms),ls("walls",r.walls,t.maxWalls),ls("doors",r.doors,t.maxDoors),ls("windows",r.windows,t.maxWindows),ls("objects",r.objects,t.maxObjects);let a=new Set([s.sceneId]),o=new Set;s.floors.forEach((l,u)=>{let h=\`floors[\${u}]\`;Vt(l,h),Ur(l.id,\`\${h}.id\`,a),o.add(l.id),Ct(l.name,\`\${h}.name\`),cd(l.level,\`\${h}.level\`),cd(l.sortOrder,\`\${h}.sortOrder\`,{nonNegative:!0}),Bt(l.elevation,\`\${h}.elevation\`),cs(l.rooms,\`\${h}.rooms\`),cs(l.walls,\`\${h}.walls\`),cs(l.doors,\`\${h}.doors\`),cs(l.windows,\`\${h}.windows\`),cs(l.objects,\`\${h}.objects\`),l.rooms.forEach((x,m)=>yg(x,\`\${h}.rooms[\${m}]\`,a,t)),l.walls.forEach((x,m)=>bg(x,\`\${h}.walls[\${m}]\`,a)),l.doors.forEach((x,m)=>ud(x,\`\${h}.doors[\${m}]\`,a)),l.windows.forEach((x,m)=>ud(x,\`\${h}.windows[\${m}]\`,a)),l.objects.forEach((x,m)=>Sg(x,\`\${h}.objects[\${m}]\`,a));let f=new Map(l.walls.map(x=>[x.id,x])),d=new Set(f.keys()),p=new Map;l.doors.forEach((x,m)=>{let g=\`\${h}.doors[\${m}]\`;if(x.wallId&&!d.has(x.wallId)&&ht(\`\${g}.wallId\`,\`"\${x.wallId}" does not reference a wall on this floor.\`),x.wallId){let w=hd(x,f.get(x.wallId),"door",g),E=p.get(x.wallId)??[];E.push({opening:w,path:g}),p.set(x.wallId,E)}}),l.windows.forEach((x,m)=>{let g=\`\${h}.windows[\${m}]\`;if(x.wallId&&!d.has(x.wallId)&&ht(\`\${g}.wallId\`,\`"\${x.wallId}" does not reference a wall on this floor.\`),x.wallId){let w=hd(x,f.get(x.wallId),"window",g),E=p.get(x.wallId)??[];E.push({opening:w,path:g}),p.set(x.wallId,E)}}),p.forEach(Mg)}),o.has(s.defaultFloorId)||ht("defaultFloorId",\`"\${s.defaultFloorId}" does not reference a floor.\`);let c=s.schemaVersion===2?[...s.floors].sort(_g):s.floors;return{...s,floors:c,activeFloorId:s.defaultFloorId}}function wg(n,e){typeof n!="string"&&ht("scene","JSON source must be a string.");let t=e?.limits?.maxJsonBytes??to.maxJsonBytes;dd(n)>t&&ht("scene",\`JSON size exceeds the maximum of \${t} bytes.\`);let i;try{i=JSON.parse(n)}catch(s){throw new Us("Scene JSON could not be parsed.",{cause:s})}return xd(i,e)}vd.exports={DASHBOARD_SCENE_LIMITS:to,DashboardSceneError:Us,SUPPORTED_SCHEMA_VERSION:cg,SUPPORTED_SCHEMA_VERSIONS:Ol,parseDashboardScene:wg,validateDashboardScene:xd}});var Ul=Ka((Fw,bd)=>{"use strict";var yd=_d(),{DashboardSceneError:io,parseDashboardScene:Tg}=yd;async function Ag(n,{fetchImpl:e=globalThis.fetch,signal:t}={}){if(typeof e!="function")throw new io("Scene loading requires fetch support.");let i;try{i=await e(n,{cache:"no-store",...t?{signal:t}:{}})}catch(r){throw new io(\`Scene could not be fetched from \${n}.\`,{cause:r})}if(!i?.ok)throw new io(\`Scene request failed with HTTP \${i?.status??"unknown"} for \${n}.\`);let s;try{s=await i.text()}catch(r){throw new io(\`Scene response from \${n} could not be read.\`,{cause:r})}return Tg(s)}bd.exports={...yd,loadDashboardScene:Ag}});var ts=Ka((LC,Bm)=>{"use strict";var Om=Object.freeze({AVAILABLE:"available",UNAVAILABLE:"unavailable",MISSING:"missing"}),dE=Object.freeze({SET_POWER:"setPower",TOGGLE_POWER:"togglePower",SET_BRIGHTNESS:"setBrightness",SET_COLOR:"setColor",SET_COLOR_TEMPERATURE:"setColorTemperature",SET_COVER_POSITION:"setCoverPosition",OPEN_COVER:"openCover",CLOSE_COVER:"closeCover",STOP_COVER:"stopCover",SET_TARGET_TEMPERATURE:"setTargetTemperature",SET_THERMOSTAT_MODE:"setThermostatMode",SET_FAN_SPEED:"setFanSpeed",SET_FAN_MODE:"setFanMode",SET_TARGET_HUMIDITY:"setTargetHumidity",START_CLEANING:"startCleaning",PAUSE_CLEANING:"pauseCleaning",STOP_CLEANING:"stopCleaning",RETURN_TO_BASE:"returnToBase",LOCK:"lock",UNLOCK:"unlock"});function wr(n){return n?.availability===Om.AVAILABLE}function fE(n){return!!(n?.power&&Object.prototype.hasOwnProperty.call(n.power,"isOn"))}function pE(n){return wr(n)&&typeof n?.power?.isOn=="boolean"}function mE(n){return wr(n)?n?.contact?.state??"unknown":"unknown"}function Nm(n){return!!n?.cover}function gE(n){return wr(n)&&Nm(n)}function Fm(n){return!!n?.climate}function xE(n){return wr(n)&&Fm(n)}function Um(n){return!!n?.cleaning}function vE(n){return wr(n)&&Um(n)}Bm.exports={DEVICE_AVAILABILITY:Om,DEVICE_COMMAND:dE,contactState:mE,hasCleaningState:Um,hasClimateState:Fm,hasCoverState:Nm,hasPowerState:fE,isAvailable:wr,isUsableCleaningState:vE,isUsableClimateState:xE,isUsableCoverState:gE,isUsablePowerState:pE}});var Ja=class{constructor(e){this.controller=new AbortController,this.signal=this.controller.signal,this.cleanups=[],this.disposed=!1;let t=()=>this.dispose();e?.aborted?this.dispose():e&&(e.addEventListener("abort",t,{once:!0}),this.defer(()=>e.removeEventListener("abort",t)))}defer(e){typeof e=="function"&&(this.disposed?e():this.cleanups.push(e))}check(){this.signal.throwIfAborted()}async wait(e){this.disposed&&(Promise.resolve(e).catch(()=>{}),this.check());let t;try{let i=await Promise.race([e,new Promise((s,r)=>{t=()=>r(this.signal.reason),this.signal.addEventListener("abort",t,{once:!0})})]);return this.check(),i}finally{this.signal.removeEventListener("abort",t)}}dispose(){if(!this.disposed){this.disposed=!0,this.controller.abort(new DOMException("Dashboard viewer was destroyed.","AbortError"));for(let e of this.cleanups.reverse())try{e()}catch(t){console.warn("Dashboard cleanup failed.",t)}this.cleanups.length=0}}};var Md=ei(Ul());function Sd(n){let e=n?.scene,t=e&&typeof e=="object"&&!Array.isArray(e)?(({activeFloorId:i,...s})=>s)(e):e;return{...n,scene:Md.default.validateDashboardScene(t)}}var Ed=\`
...
void main() {
	...
	#include <fog_fragment>
		...
		\`,blending:ri,depthTest:!1,depthWrite:!1})}function Hy(n,e,t){let i=new Float32Array(Cs),s=new D(0,1,0);return new Tn({name:"SphericalGaussianBlur",defines:{n:Cs,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:\`\${n}.0\`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:sl(),fragmentShader:\`
		...
		\`,blending:ri,depthTest:!1,depthWrite:!1})}function Yf(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sl(),fragmentShader:\`
		...
		\`,blending:ri,depthTest:!1,depthWrite:!1})}function $f(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sl(),fragmentShader:\`
	...
	\`}var nl=class extends Sn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},s=[i,i,i,i,i,i];this.texture=new ta(s),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:\`
			...
			void main() {
				...
				#endif
			}\`,depthTest:!1,depthWrite:!1}),u=new pt(c,l),h=new lr(-1,1,1,-1,0,1),f=null,d=null,p=!1,x,m=null,g=[],w=!1;this.setSize=function(E,y){a.setSize(E,y),o.setSize(E,y);for(let T=0;T<g.length;T++){let b=g[T];b.setSize&&b.setSize(E,y)}},this.setEffects=function(E){g=E,w=g.length>0&&g[0].isRenderPass===!0;let y=a.width,T=a.height;for(let b=0;b<g.length;b++){let C=g[b];C.setSize&&C.setSize(y,T)}},this.begin=function(E,y){if(p||E.toneMapping===Rn&&g.length===0)return!1;if(m=y,y!==null){let T=y.width,b=y.height;(a.width!==T||a.height!==b)&&this.setSize(T,b)}return w===!1&&E.setRenderTarget(a),x=E.toneMapping,E.toneMapping=Rn,!0},this.hasRenderPass=function(){return w},this.end=function(E,y){E.toneMapping=x,p=!0;let T=a,b=o;for(let C=0;C<g.length;C++){let v=g[C];if(v.enabled!==!1&&(v.render(E,b,T,y),v.needsSwap!==!1)){let S=T;T=b,b=S}}if(f!==E.outputColorSpace||d!==E.toneMapping){f=E.outputColorSpace,d=E.toneMapping,l.defines={},lt.getTransfer(f)===gt&&(l.defines.SRGB_TRANSFER="");let C=jy[d];C&&(l.defines[C]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=T.texture,E.setRenderTarget(m),E.render(u,h),m=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),c.dispose(),l.dispose()}}var pp=new mn,ah=new _i(1,1),mp=new Kr,gp=new Ho,xp=new ta,jf=[],Zf=[],Kf=new Float32Array(16),Jf=new Float32Array(9),Qf=new Float32Array(4);function vr(n,e,t){let i=n[0];if(i<=0||i>0)return n;let s=e*t,r=jf[s];if(r===void 0&&(r=new Float32Array(s),jf[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function Xt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function qt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function rl(n,e){let t=Zf[e];t===void 0&&(t=new Int32Array(e),Zf[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function Ky(n,e){let t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function Jy(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Xt(t,e))return;n.uniform2fv(this.addr,e),qt(t,e)}}function Qy(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Xt(t,e))return;n.uniform3fv(this.addr,e),qt(t,e)}}function eb(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Xt(t,e))return;n.uniform4fv(this.addr,e),qt(t,e)}}function tb(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(Xt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),qt(t,e)}else{if(Xt(t,i))return;Qf.set(i),n.uniformMatrix2fv(this.addr,!1,Qf),qt(t,i)}}function nb(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(Xt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),qt(t,e)}else{if(Xt(t,i))return;Jf.set(i),n.uniformMatrix3fv(this.addr,!1,Jf),qt(t,i)}}function ib(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(Xt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),qt(t,e)}else{if(Xt(t,i))return;Kf.set(i),n.uniformMatrix4fv(this.addr,!1,Kf),qt(t,i)}}function sb(n,e){let t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function rb(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Xt(t,e))return;n.uniform2iv(this.addr,e),qt(t,e)}}function ab(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Xt(t,e))return;n.uniform3iv(this.addr,e),qt(t,e)}}function ob(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Xt(t,e))return;n.uniform4iv(this.addr,e),qt(t,e)}}function cb(n,e){let t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function lb(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Xt(t,e))return;n.uniform2uiv(this.addr,e),qt(t,e)}}function ub(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Xt(t,e))return;n.uniform3uiv(this.addr,e),qt(t,e)}}function hb(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Xt(t,e))return;n.uniform4uiv(this.addr,e),qt(t,e)}}function db(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(ah.compareFunction=t.isReversedDepthBuffer()?Jc:Kc,r=ah):r=pp,t.setTexture2D(e||r,s)}function fb(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||gp,s)}function pb(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||xp,s)}function mb(n,e,t){let i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||mp,s)}function gb(n){switch(n){case 5126:return Ky;case 35664:return Jy;case 35665:return Qy;case 35666:return eb;case 35674:return tb;case 35675:return nb;case 35676:return ib;case 5124:case 35670:return sb;case 35667:case 35671:return rb;case 35668:case 35672:return ab;case 35669:case 35673:return ob;case 5125:return cb;case 36294:return lb;case 36295:return ub;case 36296:return hb;case 35678:case 36198:case 36298:case 36306:case 35682:return db;case 35679:case 36299:case 36307:return fb;case 35680:case 36300:case 36308:case 36293:return pb;case 36289:case 36303:case 36311:case 36292:return mb}}function xb(n,e){n.uniform1fv(this.addr,e)}function vb(n,e){let t=vr(e,this.size,2);n.uniform2fv(this.addr,t)}function _b(n,e){let t=vr(e,this.size,3);n.uniform3fv(this.addr,t)}function yb(n,e){let t=vr(e,this.size,4);n.uniform4fv(this.addr,t)}function bb(n,e){let t=vr(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Mb(n,e){let t=vr(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Sb(n,e){let t=vr(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Eb(n,e){n.uniform1iv(this.addr,e)}function wb(n,e){n.uniform2iv(this.addr,e)}function Tb(n,e){n.uniform3iv(this.addr,e)}function Ab(n,e){n.uniform4iv(this.addr,e)}function Cb(n,e){n.uniform1uiv(this.addr,e)}function Rb(n,e){n.uniform2uiv(this.addr,e)}function Ib(n,e){n.uniform3uiv(this.addr,e)}function Pb(n,e){n.uniform4uiv(this.addr,e)}function Db(n,e,t){let i=this.cache,s=e.length,r=rl(t,s);Xt(i,r)||(n.uniform1iv(this.addr,r),qt(i,r));let a;this.type===n.SAMPLER_2D_SHADOW?a=ah:a=pp;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function Lb(n,e,t){let i=this.cache,s=e.length,r=rl(t,s);Xt(i,r)||(n.uniform1iv(this.addr,r),qt(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||gp,r[a])}function Ob(n,e,t){let i=this.cache,s=e.length,r=rl(t,s);Xt(i,r)||(n.uniform1iv(this.addr,r),qt(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||xp,r[a])}function Nb(n,e,t){let i=this.cache,s=e.length,r=rl(t,s);Xt(i,r)||(n.uniform1iv(this.addr,r),qt(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||mp,r[a])}function Fb(n){switch(n){case 5126:return xb;case 35664:return vb;case 35665:return _b;case 35666:return yb;case 35674:return bb;case 35675:return Mb;case 35676:return Sb;case 5124:case 35670:return Eb;case 35667:case 35671:return wb;case 35668:case 35672:return Tb;case 35669:case 35673:return Ab;case 5125:return Cb;case 36294:return Rb;case 36295:return Ib;case 36296:return Pb;case 35678:case 36198:case 36298:case 36306:case 35682:return Db;case 35679:case 36299:case 36307:return Lb;case 35680:case 36300:case 36308:case 36293:return Ob;case 36289:case 36303:case 36311:case 36292:return Nb}}var oh=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=gb(t.type)}},ch=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Fb(t.type)}},lh=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){let s=this.seq;for(let r=0,a=s.length;r!==a;++r){let o=s[r];o.setValue(e,t[o.id],i)}}},sh=/(\\w+)(\\])?(\\[|\\.)?/g;function ep(n,e){n.seq.push(e),n.map[e.id]=e}function Ub(n,e,t){let i=n.name,s=i.length;for(sh.lastIndex=0;;){let r=sh.exec(i),a=sh.lastIndex,o=r[1],c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){ep(t,l===void 0?new oh(o,n,e):new ch(o,n,e));break}else{let h=t.map[o];h===void 0&&(h=new lh(o),ep(t,h)),t=h}}}var xr=class{constructor(e,t){this.seq=[],this.map={};let i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<i;++a){let o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);Ub(o,c,this)}let s=[],r=[];for(let a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,i,s){let r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){let s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){let o=t[r],c=i[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){let i=[];for(let s=0,r=e.length;s!==r;++s){let a=e[s];a.id in t&&i.push(a)}return i}};function tp(n,e,t){let i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}var Bb=37297,kb=0;function zb(n,e){let t=n.split(\`
\`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){let o=a+1;i.push(\`\${o===e?">":" "} \${o}: \${t[a]}\`)}return i.join(\`
\`)}var np=new Ze;function Hb(n){lt._getMatrix(np,lt.workingColorSpace,n);let e=\`mat3( \${np.elements.map(t=>t.toFixed(4))} )\`;switch(lt.getTransfer(n)){case jr:return[e,"LinearTransferOETF"];case gt:return[e,"sRGBTransferOETF"];default:return He("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function ip(n,e,t){let i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";let a=/ERROR: 0:(\\d+)/.exec(r);if(a){let o=parseInt(a[1]);return t.toUpperCase()+\`

\`+r+\`

\`+zb(n.getShaderSource(e),o)}else return r}function Vb(n,e){let t=Hb(e);return[\`vec4 \${n}( vec4 value ) {\`,\`	return \${t[1]}( vec4( value.rgb * \${t[0]}, value.a ) );\`,"}"].join(\`
\`)}var Gb={[Du]:"Linear",[Lu]:"Reinhard",[Ou]:"Cineon",[fr]:"ACESFilmic",[Fu]:"AgX",[Uu]:"Neutral",[Nu]:"Custom"};function Wb(n,e){let t=Gb[e];return t===void 0?(He("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var el=new D;function Xb(){lt.getLuminanceCoefficients(el);let n=el.x.toFixed(4),e=el.y.toFixed(4),t=el.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",\`	const vec3 weights = vec3( \${n}, \${e}, \${t} );\`,"	return dot( weights, rgb );","}"].join(\`
\`)}function qb(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ra).join(\`
\`)}function Yb(n){let e=[];for(let t in n){let i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(\`
\`)}function $b(n,e){let t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){let r=n.getActiveAttrib(e,s),a=r.name,o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Ra(n){return n!==""}function sp(n,e){let t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rp(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}var jb=/^[ \\t]*#include +<([\\w\\d./]+)>/gm;function uh(n){return n.replace(jb,Kb)}var Zb=new Map;function Kb(n,e){let t=st[e];if(t===void 0){let i=Zb.get(e);if(i!==void 0)t=st[i],He('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return uh(t)}var Jb=/#pragma unroll_loop_start\\s+for\\s*\\(\\s*int\\s+i\\s*=\\s*(\\d+)\\s*;\\s*i\\s*<\\s*(\\d+)\\s*;\\s*i\\s*\\+\\+\\s*\\)\\s*{([\\s\\S]+?)}\\s+#pragma unroll_loop_end/g;function ap(n){return n.replace(Jb,Qb)}function Qb(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\\[\\s*i\\s*\\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function op(n){let e=\`precision \${n.precision} float;
...
#define LOW_PRECISION\`),e}var eM={[Es]:"SHADOWMAP_TYPE_PCF",[dr]:"SHADOWMAP_TYPE_VSM"};function tM(n){return eM[n.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}var nM={[$i]:"ENVMAP_TYPE_CUBE",[ws]:"ENVMAP_TYPE_CUBE",[_a]:"ENVMAP_TYPE_CUBE_UV"};function iM(n){return n.envMap===!1?"ENVMAP_TYPE_CUBE":nM[n.envMapMode]||"ENVMAP_TYPE_CUBE"}var sM={[ws]:"ENVMAP_MODE_REFRACTION"};function rM(n){return n.envMap===!1?"ENVMAP_MODE_REFLECTION":sM[n.envMapMode]||"ENVMAP_MODE_REFLECTION"}var aM={[Pu]:"ENVMAP_BLENDING_MULTIPLY",[Mf]:"ENVMAP_BLENDING_MIX",[Sf]:"ENVMAP_BLENDING_ADD"};function oM(n){return n.envMap===!1?"ENVMAP_BLENDING_NONE":aM[n.combine]||"ENVMAP_BLENDING_NONE"}function cM(n){let e=n.envMapCubeUVHeight;if(e===null)return null;let t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function lM(n,e,t,i){let s=n.getContext(),r=t.defines,a=t.vertexShader,o=t.fragmentShader,c=tM(t),l=iM(t),u=rM(t),h=oM(t),f=cM(t),d=qb(t),p=Yb(r),x=s.createProgram(),m,g,w=t.glslVersion?"#version "+t.glslVersion+\`
...
\`)+\`
\`+g);let E=w+m+a,y=w+g+o,T=tp(s,s.VERTEX_SHADER,E),b=tp(s,s.FRAGMENT_SHADER,y);s.attachShader(x,T),s.attachShader(x,b),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.hasPositionAttribute===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(I){if(n.debug.checkShaderErrors){let O=s.getProgramInfoLog(x)||"",U=s.getShaderInfoLog(T)||"",q=s.getShaderInfoLog(b)||"",R=O.trim(),H=U.trim(),z=q.trim(),k=!0,$=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(k=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,T,b);else{let se=ip(s,T,"vertex"),ae=ip(s,b,"fragment");Ge("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+\`
...
three/build/three.module.js:
   ...
   *)
*/
`;var Q=`<!doctype html><html><head><meta charset="utf-8"><style>
html,body{margin:0;width:100%;height:100%;font:14px system-ui,sans-serif;color:#222;background:#f3f4f4}
#shell{position:relative;display:flex;flex-direction:column;width:100%;height:100%}
#header{flex:0 0 auto;box-sizing:border-box;display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:8px;padding:12px;min-height:56px}
#viewport{position:relative;flex:1;width:100%;min-height:180px;overflow:hidden}
#viewport canvas{display:block;width:100%;height:100%}
#summary{flex:0 0 auto;margin:0;padding:4px 12px}button,select,input{font:inherit}button,select{min-height:44px}
[hidden]{display:none!important}#error{padding:12px}
</style></head><body><main id="shell"><header id="header"><span id="floor-label"></span><div id="floor-selector"></div></header><div id="viewport"></div><p id="summary"></p></main><p id="error" hidden></p></body></html>`;function G({container:r,runtime:e,scene:t,sceneSource:s,storage:a,onReady:i,onError:o}){let n=document.createElement("iframe");n.title="Mikonus 3D Dashboard",n.style.cssText="display:block;width:100%;height:100%;border:0";let l=null,_=!1,d=new AbortController,u=URL.createObjectURL(new Blob([H],{type:"text/javascript"})),c=()=>{if(!_){_=!0,d.abort(),n.removeEventListener("mikonus-frame-ready",g),n.removeEventListener("load",p);try{l?.dispose()}finally{l=null,e.dispose(),n.remove(),URL.revokeObjectURL(u)}}},f=h=>{_||(c(),o(h))},g=()=>{if(!_)try{n.contentDocument.dispatchEvent(new n.contentWindow.CustomEvent("mikonus-connect",{detail:{runtime:e,scene:t,sceneSource:s,storage:a,signal:d.signal,initializeRuntime:h=>e.configureCommandSupport(h),onReady:h=>{if(URL.revokeObjectURL(u),_){h.dispose();return}l=h,i()},onError:f}}))}catch(h){f(h)}},p=()=>{if(!_)try{let h=n.contentDocument.createElement("script");h.src=u,h.onerror=()=>f(new Error("Renderer script could not be loaded. Check the browser content policy.")),n.contentDocument.body.append(h)}catch(h){f(h)}};return n.addEventListener("load",p,{once:!0}),n.addEventListener("mikonus-frame-ready",g,{once:!0}),n.srcdoc=Q,r.append(n),{dispose:c}}document.querySelector("home-assistant")&&await customElements.whenDefined("home-assistant");var R="mikonus-3d-card";customElements.get(R)||customElements.define(R,V(G));window.customCards??=[];window.customCards.some(r=>r.type===R)||window.customCards.push({type:R,name:"Mikonus 3D",preview:!1,description:"Mikonus Dashboard Scene v2 mit Home Assistant Ger\xE4ten."});
